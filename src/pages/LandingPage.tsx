...
//             {user?.role === "student" ? (
//   <button onClick={()=>navigate('/student/dashboard')} className="bg-blue-600 text-white px-6 py-3 rounded-lg text-lg hover:bg-blue-700 transition">
//     Student Dashboard
//   </button>
// ) : user?.role === "faculty" ? (
  ...
  const features = [
    {
      ...
      description: 'Learn from industry professionals with years of real-world experience and proven teaching methodologies.',
    ...
    },
    {
      ...
      description: 'Experience cutting-edge educational technology and interactive learning platforms designed for success.',
    ...
    <div className="scroll-smooth overflow-hidden">
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-600 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 pointer-events-none">
          <svg width="200" height="200" className="animate-spin-slow opacity-20">
            <circle cx="100" cy="100" r="80" fill="none" stroke="#3B82F6" strokeWidth="2" strokeDasharray="5,5"/>
            <circle cx="100" cy="100" r="60" fill="none" stroke="#2563EB" strokeWidth="2"/>
            <circle cx="100" cy="100" r="40" fill="none" stroke="#1D4ED8" strokeWidth="2" strokeDasharray="3,3"/>
          </svg>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-5rem)]">
            ...
            <div className="space-y-8 animate-fade-in-up">
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm font-bold text-blue-600 tracking-widest uppercase">Welcome to Excellence</span>
                </div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed max-w-xl">
                  Transform your future with world-class education. Join thousands of students who have 
                  achieved their dreams through our comprehensive programs and cutting-edge learning platforms.
                </p>
              </div>

              {/* CTA Buttons with geometric accents */}
              <div className="flex flex-wrap gap-4">
                <button className="group relative overflow-hidden bg-gradient-to-r from-blue-600 to-blue-500 text-white px-10 py-5 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105 active:scale-95">
                ...
                <button className="group relative overflow-hidden bg-white text-blue-600 border-3 border-blue-600 px-10 py-5 rounded-2xl font-bold text-lg shadow-lg hover:bg-blue-50 transition-all duration-300 hover:scale-105 active:scale-95">
                  <span className="relative z-10 flex items-center gap-2">
                    Learn More
              ...
              <div className="flex flex-wrap gap-4 pt-8">
                <div className="group relative bg-white rounded-3xl shadow-xl p-6 hover:shadow-2xl transition-all duration-300 border-2 border-blue-100 hover:border-blue-300 hover:-translate-y-2">
                  ...
                  <div className="text-sm text-gray-600 font-semibold mt-1">Active Students</div>
                ...
                <div className="group relative bg-white rounded-3xl shadow-xl p-6 hover:shadow-2xl transition-all duration-300 border-2 border-blue-100 hover:border-blue-300 hover:-translate-y-2">
                  ...
                  <div className="text-4xl font-black bg-gradient-to-r from-indigo-600 to-purple-400 bg-clip-text text-transparent">500+</div>
                  <div className="text-sm text-gray-600 font-semibold mt-1">Premium Courses</div>
            ...
            <div className="relative animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              <div className="relative">
                {/* Trigonometric grid background */}
                <div className="absolute inset-0 -z-10">
                  <svg className="w-full h-full opacity-10">
                    <defs>
                      <pattern id="hero-grid" width="40" height="40" patternUnits="userSpaceOnUse">
                        <circle cx="20" cy="20" r="1" fill="#2563EB"/>
                        <path d="M0,20 L40,20 M20,0 L20,40" stroke="#3B82F6" strokeWidth="0.5" opacity="0.5"/>
                      </pattern>
                    </defs>
                ...
                <div className="absolute top-1/4 -right-12 w-24 h-24 bg-gradient-to-br from-blue-300 to-blue-500 transform -rotate-12 animate-float-delay-2 shadow-xl opacity-60" style={{clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)'}}></div>
                
                {/* Main image container with advanced design */}
                <div className="relative bg-gradient-to-br from-blue-400 via-blue-500 to-indigo-500 rounded-3xl shadow-2xl overflow-hidden aspect-square transform hover:scale-105 transition-transform duration-500">
                  {/* Trigonometric pattern overlay */}
                  <div className="absolute inset-0">
                    <svg className="w-full h-full opacity-20">
                      <defs>
                        <pattern id="main-pattern" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
                          <path d="M30,0 L30,60 M0,30 L60,30" stroke="white" strokeWidth="1" opacity="0.3"/>
                          <circle cx="30" cy="30" r="20" fill="none" stroke="white" strokeWidth="1" opacity="0.5"/>
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center h-full p-12">
                    <div className="relative mb-8">
                      <div className="w-48 h-48 bg-blue-400/30 backdrop-blur-lg rounded-full flex items-center justify-center border-4 border-white/40 shadow-2xl">
                        <img 
                          src={logo} 
                      ...
                      <div className="absolute inset-0 animate-spin-slow">
                        <div className="absolute top-0 left-1/2 w-5 h-5 bg-white rounded-full transform -translate-x-1/2 -translate-y-1/2 shadow-lg"></div>
                      </div>
                    ...
                    <h3 className="text-3xl font-black text-white mb-2 text-center">Excellence Institute</h3>
                    <p className="text-blue-100 text-lg font-medium text-center">Learning Today Leading Tomorrow</p>
      ...
      <section className="relative bg-white py-24 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full">
            <defs>
              <pattern id="features-pattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                ...
                <path d="M50,20 L80,50 L50,80 L20,50 Z" fill="none" stroke="#60A5FA" strokeWidth="1"/>
              </pattern>
            </defs>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-blue-50 px-6 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-bold text-blue-600 tracking-wider uppercase">Our Features</span>
            </div>
            <h2 className="text-5xl lg:text-6xl font-black text-gray-900 mb-6">
              ...
              <span className="relative inline-block">
                ...
                <svg className="absolute -bottom-2 left-0 w-full" height="12" viewBox="0 0 200 12">
                  <path d="M5,7 Q50,2 100,7 T195,7" fill="none" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round"/>
                </svg>
              </span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Discover the innovative features that make us the premier choice for quality education
            </p>
          </div>
              ...
              >
                ...
                <div className="relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transform hover:-translate-y-3 transition-all duration-500 border-2 border-gray-100 group-hover:border-blue-200 overflow-hidden">
                  ...
                  <div className="absolute top-0 right-0 w-32 h-32 opacity-5 group-hover:opacity-10 transition-opacity">
                    <svg className="w-full h-full">
                      <circle cx="64" cy="16" r="40" fill="none" stroke="currentColor" strokeWidth="2"/>
                      <circle cx="64" cy="16" r="20" fill="none" stroke="currentColor" strokeWidth="1"/>
                    </svg>
                  </div>

                  {/* Icon container with gradient */}
                  <div className={`relative bg-gradient-to-br ${feature.color} w-20 h-20 rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
                    {feature.icon}
                    {/* Orbiting dot */}
                    <div className="absolute inset-0 animate-spin-slow">
      ...
      <section id="statistics-section" className="relative py-24 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <svg className="w-full h-full" preserveAspectRatio="none">
            <defs>
              <pattern id="stats-pattern" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
                <circle cx="40" cy="40" r="30" fill="none" stroke="rgba(255,255,255,0.1)" strokeWidth="2"/>
                <path d="M0,40 Q20,20 40,40 T80,40" fill="none" stroke="rgba(255,255,255,0.05)" strokeWidth="2"/>
              </pattern>
            </defs>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-black text-white mb-4">Our Impact in Numbers</h2>
            <p className="text-blue-100 text-xl font-medium">Join a thriving community of learners and achievers</p>
          </div>

          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { value: stats.students, suffix: '+', label: 'Active Students'},
              { value: stats.courses, suffix: '+', label: 'Premium Courses'},
              { value: stats.instructors, suffix: '+', label: 'Expert Instructors'},
              { value: stats.satisfaction, suffix: '%', label: 'Satisfaction Rate'}
            ].map((stat, index) => (
                ...
                <div className="relative text-center p-6 rounded-2xl bg-white/5 backdrop-blur-sm border-2 border-white/20 group-hover:border-white/40 transition-all duration-500">
                  ...
                  <div className="relative inline-block">
                    ...
                    <svg className="absolute -bottom-2 left-0 w-full" height="8" viewBox="0 0 200 8">
                      <path d="M0,4 Q50,0 100,4 T200,4" fill="none" stroke="rgba(255,255,255,0.5)" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
                  </div>
                  
                  <div className="text-blue-100 text-base font-semibold mt-3">{stat.label}</div>
          ...
          <svg className="w-full h-full">
            <defs>
              <pattern id="cta-pattern" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
                <path d="M60,0 L60,120 M0,60 L120,60" stroke="#93C5FD" strokeWidth="1" opacity="0.3"/>
                <circle cx="60" cy="60" r="40" fill="none" stroke="#60A5FA" strokeWidth="1" opacity="0.5"/>
                <circle cx="60" cy="60" r="20" fill="none" stroke="#3B82F6" strokeWidth="1" opacity="0.7"/>
              </pattern>
            </defs>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-white rounded-[3rem] shadow-2xl p-12 lg:p-20 overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-96 h-96 opacity-5">
              <svg className="w-full h-full">
                <circle cx="300" cy="100" r="150" fill="none" stroke="#2563EB" strokeWidth="3"/>
                <circle cx="300" cy="100" r="100" fill="none" stroke="#3B82F6" strokeWidth="2"/>
                <circle cx="300" cy="100" r="50" fill="none" stroke="#60A5FA" strokeWidth="1"/>
              </svg>
            </div>
            ...
            <div className="relative text-center">
              <div className="inline-flex items-center gap-2 bg-blue-100 px-6 py-3 rounded-full mb-8">
                ...
                <span className="text-sm font-bold text-blue-700 tracking-wider uppercase">Limited Time Offer</span>
              </div>
              ...
              <h2 className="text-5xl lg:text-6xl font-black text-gray-900 mb-6 leading-tight">
                ...
                <span className="relative inline-block">
                  ...
                  <svg className="absolute -bottom-2 left-0 w-full" height="12" viewBox="0 0 400 12">
                    <path d="M5,7 Q100,2 200,7 T395,7" fill="none" stroke="#8B5CF6" strokeWidth="4" strokeLinecap="round" opacity="0.5"/>
                  </svg>
                </span>
              </h2>
              ...
              <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
                ...
                programs. Get instant access to all courses and start learning today with expert guidance.
              </p>

              <div className="flex flex-wrap justify-center gap-6">
                <button className="group relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white px-12 py-5 rounded-2xl font-bold text-xl shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 hover:scale-110 active:scale-95">
      ...
      <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white pt-20 pb-10 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 group cursor-pointer">
                ...
                />
                <div>
                  <span className="font-black text-xl block">Excellence Institute</span>
                </div>
              </div>
              <p className="text-gray-400 leading-relaxed">
                Empowering students worldwide with quality education and innovative learning solutions for a better future.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Home', 'About Us', 'Courses', 'Faculties', 'Gallery'].map((link) => (
                  <li key={link}>
                    <a href="#" className="group flex items-center text-gray-400 hover:text-blue-400 transition-all">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Undergraduate', 'Graduate', 'Online Learning', 'Certifications', 'Professional Development'].map((program) => (
                  <li key={program}>
                    <a href="#" className="group flex items-center text-gray-400 hover:text-purple-400 transition-all">
                      <svg className="w-4 h-4 mr-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                      {program}
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                <li className="flex items-start gap-3 group hover:text-green-400 transition-colors">
                  ...
                  <span className="leading-relaxed">123 Education Street, Knowledge City, ED 12345</span>
                </li>
                <li className="flex items-center gap-3 group hover:text-blue-400 transition-colors">
                  ...
                  <span>info@excellenceinstitute.edu</span>
                </li>
          ...
          <div className="relative border-t border-gray-800 pt-10">
            {/* Top wave decoration */}
            <svg className="absolute -top-px left-0 w-full h-2" preserveAspectRatio="none" viewBox="0 0 1200 4">
              <path d="M0,2 Q300,0 600,2 T1200,2" fill="none" stroke="url(#footer-gradient)" strokeWidth="2"/>
              <defs>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex flex-wrap gap-6 text-sm">
                {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((link) => (
                  <a key={link} href="#" className="text-gray-400 hover:text-blue-400 transition-colors relative group">
                    {link}
