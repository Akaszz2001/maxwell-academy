...
import { Button } from "@/components/ui/button";
import { Calendar, Pencil, Copy, Power, PowerOff, Search } from "lucide-react";
import { useExamStore } from "../../store/examStore";
import { useAuthStore } from "../../store/authStore";
import { useNavigate } from "react-router-dom";
              ...
              <div>
                ...
                <CardContent>
                  <div className="flex items-center text-lg mt-4">
                    ...
                    ></span>
                    <span
                      className={exam.isActive ? "text-green-600" : "text-red-600"}
                    >
                      {exam.isActive ? "Active" : "Deactivated"}
                    </span>
                  </div>
                ...
                <div className="flex gap-2">
                  {exam.isActive && (
                    <Button
                      ...
                      className="rounded-full bg-red-500 text-white hover:bg-red-600 shadow-md hover:scale-110 transition"
                    >
                      <PowerOff size={18} />
                    </Button>
                  )}
